...
// ── Chapter tiles: math images as placeholder ─────────────────────────────────
const TILES = [
...
export function KannadaChapterMapPage({ onChapterSelect, onBack }: Props) {
  ...
  const kannadaChapters = chapters.filter(c => c.chapter_number <= 5);
  const progressPct     = kannadaChapters.length / 5;
  ...
  return (
    <div className="relative overflow-hidden"
      ...
      {/* Background — reuse maths background as placeholder */}
      ...
      <header className="relative flex items-center px-6 py-3.5 gap-4 flex-shrink-0"
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl"
          ...
          <span className="text-xs font-bold" style={{ color:"#2563eb" }}>Board: CBSE</span>
        </div>
      </header>
      ...
      <div className="relative" style={{ height:"calc(100dvh - 57px)", zIndex:10 }}>
        ...
        <motion.div initial={{ opacity:0, scale:0.8 }} animate={{ opacity:1, scale:1 }}
          ...
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/classroom/mathematics/mid_term_exam.png" alt="ಮಧ್ಯಂತರ ಪರೀಕ್ಷೆ"
        ...
        <motion.div initial={{ opacity:0, x:-20 }} animate={{ opacity:1, x:0 }}
          ...
          <div className="flex items-center gap-4 mb-3">
            ...
            <div className="space-y-2 flex-1">
              {[
                { label:"Chapters Completed", value:`${kannadaChapters.length}/5` },
        ...
        <motion.div initial={{ opacity:0, x:20 }} animate={{ opacity:1, x:0 }}
          ...
          <div className="flex-shrink-0 flex items-center gap-2 px-3 py-2.5"
            style={{ background:"linear-gradient(135deg,rgba(37,99,235,0.10),rgba(0,212,255,0.05))",
            ...
            <>
              {podium.length === 3 && (
                <div className="flex-shrink-0 flex items-end gap-1 px-3 pt-4 pb-1"
                  style={{ background:"linear-gradient(180deg,rgba(37,99,235,0.04),transparent)" }}>
