...
// ── Same pentagon geometry as Chemistry & Mathematics ─────────────────────────
const TILES = [
  { key:"ch1", src:"/classroom/KANNADA/KANNADA 1 (2).png", num:1, locked:false,
    style:{ top:"calc(50% - 362px)", left:"calc(47% - 150px)" } },
  { key:"ch2", src:"/classroom/KANNADA/KANNADA2.png", num:2, locked:true,
...
export function KannadaChapterMapPage({ onChapterSelect, onBack }: Props) {
  ...
  useEffect(() => {
    Promise.all([
      ...
      setChapters((chapData.chapters as Chapter[]).filter(
