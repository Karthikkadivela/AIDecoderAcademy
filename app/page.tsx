...
export default function LandingPage() {
  return (
    <main className="min-h-screen bg-[#EEF0FF] relative overflow-hidden">
      ...
      <section className="relative z-10 text-center px-5 sm:px-8 pt-12 sm:pt-20 pb-16 sm:pb-24 max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl sm:text-6xl font-black text-[#1a1a2e] leading-tight mb-6">
          Learn anything with{" "}
          <span className="text-[#6C47FF]">your own AI tutor</span>
        </h1>
        <p className="text-xl text-slate-600 max-w-2xl mx-auto mb-10">
          Write stories, create images, make audio scenes — unlock 6 immersive arenas as you level up.
        </p>
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-8 pb-24">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 sm:gap-4">
          {[
            { emoji:"🚀", label:"AI Explorer",   bg:"bg-purple-50 border-purple-200", text:"text-purple-600" },
            { emoji:"⚡", label:"Prompt Lab",     bg:"bg-blue-50   border-blue-200",   text:"text-blue-600"   },
            { emoji:"📖", label:"Story Forge",    bg:"bg-orange-50 border-orange-200", text:"text-orange-600" },
            { emoji:"🎨", label:"Visual Studio",  bg:"bg-green-50  border-green-200",  text:"text-green-600"  },
            { emoji:"🎬", label:"Director Suite", bg:"bg-yellow-50 border-yellow-200", text:"text-yellow-600" },
          ].map(m => (
            <div key={m.label} className={`${m.bg} border-2 text-center p-6 rounded-3xl hover:scale-105 transition-transform`}>
