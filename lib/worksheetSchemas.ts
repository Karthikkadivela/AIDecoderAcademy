...
export const OBJ9_SCHEMA: WorksheetSchema = {
  ...
  sections: [
    { id: "header", title: "Header", fields: [{ kind: "text", id: "avatarName", label: "Avatar Name", placeholder: "Your Avatar Name", optional: true }] },
    {
    ...
    },
    {
      ...
      fields: [
        ...
        { kind: "text", id: "auditItem1", label: "Uninvited element 1", description: "Be specific: 'blue sky with scattered clouds', not 'background'.", placeholder: "e.g. blue sky with scattered clouds", optional: true },
        { kind: "text", id: "auditItem2", label: "Uninvited element 2", placeholder: "e.g. shadow beneath subject", optional: true },
        { kind: "text", id: "auditItem3", label: "Uninvited element 3", placeholder: "e.g. depth-of-field blur", optional: true },
        { kind: "text", id: "auditItem4", label: "Uninvited element 4", placeholder: "e.g. golden-hour lighting", optional: true },
        { kind: "text", id: "auditItem5", label: "Uninvited element 5", placeholder: "e.g. distant mountains", optional: true },
        ...
        { kind: "longtext", id: "predictionVsActual", label: "Predictions vs actual", description: "Which Think-It predictions were correct? Which were wrong? What surprised you?", rows: 3, minWords: 15, optional: true },
        { kind: "longtext", id: "v2NegativePrompt", label: "Version 2 negative prompt", description: "Choose 2-4 most prominent uninvited elements. e.g. 'no sky, no people, no shadows'.", rows: 2, minWords: 4, optional: true },
        { kind: "longtext", id: "v3NegativePrompt", label: "Version 3 negative prompt (extends V2)", description: "Include EVERYTHING from V2 + 2-3 more excluded elements.", rows: 2, minWords: 6, optional: true },
      ],
    },
    {
